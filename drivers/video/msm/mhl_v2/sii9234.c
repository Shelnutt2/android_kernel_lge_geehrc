...
#endif
//static cbus_command_abort_state;
...
int sii9234_enqueue_msc_work(struct sii9234_data *sii9234, u8 command,
...
int sii9234_msc_req_locked(struct sii9234_data *sii9234,
