...
void dbg_log_event(struct urb *urb, char * event, unsigned extra,
	char * event1, int extra1, char * event2, int extra2);
...
static void end_unlink_async (struct ehci_hcd *ehci)
{
	...
	dbg_log_event(NULL,"end_unlink_async: WD done qh:",(unsigned)qh,"",0,"",0);
...
alter:
	...
	dbg_log_event(NULL,"start_unlink_async: WD start qh:",(unsigned)qh,"",0,"",0);
