...
ifeq ($(PRODUCT_SUPPORT_EXFAT), y)
	...
	@sh tuxera_update.sh --target target/lg.d/mobile-mtp --use-cache --source-dir $(ANDROID_BUILD_TOP)/kernel --output-dir $(ANDROID_BUILD_TOP)/$(KERNEL_OUT) -a --user lg-mobile --pass AumlTsj0ou
